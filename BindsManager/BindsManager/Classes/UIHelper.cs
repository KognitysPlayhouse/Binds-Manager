...
namespace BindsManager.Classes
{
    public static class UIHelper // Switched to 'UIHelper' for future use with better UI
    {
        ...
        public static void SendTextBox(string description, string title)
        {
            ...
            ok.Click += (sender, e) => { textBox.Close(); }; // There's no need to make a method for just 1 line.

            textBox.Controls.Add(text);
            textBox.Controls.Add(ok);

            textBox.AcceptButton = ok;
